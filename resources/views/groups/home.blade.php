		...
		<div class="box border-top-left-radius border-top-right-radius margin-15">
			...
			<div class="col-md-12 bg-grey margin-15-responsive comment-text" style="padding: 10px;">
				<div class="media">
					...
					<div class="media-body">
						<a href="#" class="grey">
							<h5 class="media-heading">Indra Harta Kenda</h5>
							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti, nesciunt cum animi eveniet perferendis unde non a iusto vel optio eaque hic voluptatem maxime eos repellat adipisci consectetur? Soluta, excepturi! <br />
							2 Minute Ago
						</a>
					</div>
				</div>
