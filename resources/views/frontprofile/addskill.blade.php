	...
	<div class="row">
		<div class="col-md-9">
			...
			<div class="wrapper" style="margin-bottom: 20px;">
				<div class="row">
					<form method="post" id="form-add-edu" action="{{ route('profile_post_addskill') }}">
					{!! csrf_field() !!}
					<div class="col-md-12">
											...
											<div class="row">
												<div class="col-xs-6 col-sm-6 col-md-6">
													<div style="margin-bottom: 10px;">
														<span>Skill</span><span style="color: red;">*</span>
														<input type="text" name="name[][name]" value="" class="form-control">
													</div>
												</div>
												<div class="col-xs-6 col-sm-6 col-md-6">
													<div style="margin-bottom: 10px;">
