...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Group Types</h1>
        <h1 class="pull-right">
        <div class="col-md-6">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('groupTypes.create') !!}">Add New</a>
        </div>
            <div class="col-md-6">
            <div class="dropdown">
