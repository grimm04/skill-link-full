...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">Company Industries</h1>
        <h1 class="pull-right">
        <div class="col-md-6">
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('companyIndustries.create') !!}">Add New</a>
        </div>
            <div class="col-md-6">
            <div class="dropdown">
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                    @include('company_industries.table')
            </div>
        </div>
