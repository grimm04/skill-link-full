					...
					<div class="col-md-12">
						<div class="box border-all-radius" style="margin-bottom: 15px;">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div style="margin-bottom: 10px;">
										...
										<input type="number" value="012939" class="form-control">
									</div>
								</div>
								<div class="col-md-4">
									<div style="margin-bottom: 10px;">
							...
							<div style="text-align: center;margin: 10px 0px;">
								<button class="btn bg-red" style="color: #fff;">Delete Ticket</button>
							</div>
						</div>
					</div>
				</div>
				<div style="text-align: center; margin: 10px 0px;">
					<button class="btn bg-yellow" style="color: #fff;">Add More Ticket</button>
				</div>
			</div>
		</div>
	</div>
