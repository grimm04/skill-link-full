							...
							<div class="box-body" id="table-info">
								<table class="table">
									<tbody>
										...
										<tr>
											<td>Birthday</td>
											<td><b><input type="text" name="birth" id="birth" value="{{ $edit->birth->format('M') }} {{ $edit->birth->format('d') }}, {{ $edit->birth->format('Y') }}" class="form-control"></b></td>
										</tr>
										<tr>
											<td>Lives in</td>
											<td>
												...
												<input type="text" name="province" id="province" value="{{ $edit->province->name }}, {{ $edit->province->country }}" class="form-control">
												</b>
											</td>
										</tr>
										<tr>
											...
											<td><b>
												...
												<input type="text" name="chtrade" id="chtrade" value="{{ $edit->chtrade->name }}" class="form-control"></b>
											</td>
										</tr>
										<tr>
											<td>Joined</td>
											<td><b><input type="text" name="" id="" value="{{ $edit->created_at->format('M') }} {{ $edit->created_at->format('d') }}, {{ $edit->created_at->format('Y') }}" class="form-control" disabled=""></b></td>
										</tr>
										<tr>
											<td>Gender</td>
											<td>
