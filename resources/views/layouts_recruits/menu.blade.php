<li class="treeview menu-open">
    <a href="#">
    <i class="fa fa-user"></i> <span>Interviews</span>
...
<li class="treeview menu-open">
    <a href="#">
    <i class="fa fa-building"></i> <span>Employee Grader</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
...
<li class="treeview menu-open">
    <a href="#">
    <i class="fa fa-briefcase"></i> <span>Help</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
...
<li class="treeview menu-open">
    <a href="#">
    <i class="fa fa-edit"></i> <span>Log Out</span>
        <span class="pull-right-container">
          <i class="fa fa-angle-left pull-right"></i>
        </span>
    </a>
