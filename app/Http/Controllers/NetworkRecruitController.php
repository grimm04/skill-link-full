...
class NetworkRecruitController extends Controller
{
    ...
    {	
	    ...
	    $following = Employee::with('province')->where('employe_status',2)->whereNotIn('id',[Auth::user()->id])->whereNotIn('id',$userid)->get();    
    ...
    {	
    	...
    	return view('recruitnetwork.index',compact('networkprofile','og','followid'));
    }  
